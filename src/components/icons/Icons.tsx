  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.333A12.004 12.004 0 0012 9c-2.474 0-4.73.751-6.6 2.033V21m15 0H3"
      />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5m14.25-5.682l-4.091-4.091a2.25 2.25 0 01-.659-1.591V3.104m-4.5 0h4.5m-4.5 0a2.25 2.25 0 00-2.25 2.25v.75m6.75-3v.75a2.25 2.25 0 01-2.25 2.25M5 14.5l-1.32 1.32a2.25 2.25 0 00-.68 1.59V19.5A2.25 2.25 0 005.25 21.75h13.5A2.25 2.25 0 0021 19.5v-2.09a2.25 2.25 0 00-.68-1.59L19 14.5M5 14.5h14"
      />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.398-3.085 1.22l-7.79 7.79a2.25 2.25 0 01-3.182-3.182l7.79-7.79c.822-.821 1.311-2.01 1.22-3.085A4.5 4.5 0 0117.25 2.25h1.5a.75.75 0 01.75.75v1.5a2.25 2.25 0 002.25 2.25h.75a.75.75 0 01.75.75v1.5z"
      />
    </svg>
  )
}
