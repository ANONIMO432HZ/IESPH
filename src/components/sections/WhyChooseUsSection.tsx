...
export default function WhyChooseUsSection({
  ...
  return (
    <div id="nosotros" className="font-sans">
      {/* ── 1. Comprometidos con la excelencia en educación ────────────── */}
      <section className="py-16 sm:py-24 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base mt-3 leading-relaxed text-justify">
                  ...
                  somos el referente de educación superior pública y gratuita en
                  la provincia y la región Ayacucho.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div
                  onClick={() => onOpenAboutModal?.("mision-vision")}
                  className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-600 transition-colors cursor-pointer group flex items-start gap-3.5"
                >
                ...
                <div
                  onClick={() => onOpenAboutModal?.("presentacion")}
                  className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-600 transition-colors cursor-pointer group flex items-start gap-3.5"
                >
      ...
      <section className="relative py-20 sm:py-28 bg-[#0b1730] text-white overflow-hidden">
        {/* Background Image: Graduates Celebration (from Image 1 / 434836160...) */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6">
          ...
          <button
            ...
            aria-label="Ver video o presentación institucional"
          >
            <svg
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              type="button"
              onClick={() => onOpenAboutModal?.("plana-docente")}
      ...
      {/* ── 3. Tabs: Ofrecemos Educación Técnico De Alta Calidad ──────── */}
      <section className="py-16 sm:py-24 bg-slate-50 dark:bg-slate-900/60 border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tracking-tight mt-1">
              Ofrecemos Educación Técnico De Alta Calidad
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            {/* Left Photo of Students (from Image 1 / mision.jpg) */}
